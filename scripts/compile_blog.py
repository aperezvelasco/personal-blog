...
directory, fetches relevant weekly geoscience papers from the arXiv API,
merges them chronologically, and saves them to data/posts.json.
"""
...
def compile_all_posts() -> None:
    ...
    print(
        f"Blog compiled successfully. Total posts: {len(all_posts)}. "
